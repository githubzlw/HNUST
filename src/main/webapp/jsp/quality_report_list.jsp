				...
				<td>
					<ul>
						<li class="display_inline_block mr20" >
							<a href="https://www.kuaizhizao.cn/quality/shareQuality?id=${obj.id}&userName=${userName}" target="_blank"><span><b>${obj.projectNo}</b></span></a>
						</li>
						<li class="display_inline_block mr20">
							<a href="https://www.kuaizhizao.cn/quality/shareQuality?id=${obj.id}&userName=${userName}" target="_blank"><span><b>${obj.projectName}</b></span></a>
						</li>
						<li class="display_inline_block mr20">
