...
public class RpcEfficiencyReportHelper {

	private final static Logger log = Logger.getLogger(RpcEfficiencyReportHelper.class);
	...
	public static void sendRequest(String url, Object obj) {
		try {
			...
			url = reader.getProperty("erp_path")+"/helpServlet?action=efficiencyReport&className=ExternalinterfaceServlet";
			}
			JSONObject object = JSONObject.fromObject(obj);
			Map<String, String> parameters = new HashMap<String, String>();
			parameters.put("efficiencyReport", object.toString());	
			new Thread(new RpcEfficiencyReportHelper().new SendHttp(url,parameters)).start();;
