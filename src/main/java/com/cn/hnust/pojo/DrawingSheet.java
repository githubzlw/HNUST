...
public class DrawingSheet {
	 private String id;
		...
		public String toString() {
			return "DrawingSheet [id=" + id + ", projectNo=" + projectNo
					+ ", drawingName=" + drawingName + ", createDate="
					+ createDate + ", category=" + category + ", remark="
					+ remark + ", uploadTime=" + uploadTime + ", name=" + name
